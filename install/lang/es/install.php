<?php
// This file is part of Ingenium - https://moodle.org/
//
// Ingenium is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// Ingenium is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with Ingenium.  If not, see <https://www.gnu.org/licenses/>.

/**
 * Automatically generated strings for Ingenium installer
 *
...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para instalar Ingenium en este sitio.';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar Ingenium en este sitio.';
$string['cliinstallheader'] = 'Programa de instalación Ingenium de línea de comando {$a}';
...
$string['dirroot'] = 'Directorio de Ingenium';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de Ingenium tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP.
...
<p>Esto puede ocasionar que Ingenium tenga problemas de memoria más adelante, especialmente si usted tiene activados muchos módulos y/o muchos usuarios.</p>
...
Esto hace que Ingenium fije por sí mismo el límite de memoria.</li>
...
<li>En algunos servidores PHP puede crear en el directorio Ingenium un archivo .htaccess que contenga esta línea:
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de Ingenium. Usted puede solucionar este problema, renombrando el directorio admin en su instalación Ingenium, poniendo un nuevo nombre aquí. Por ejemplo: <em> moodleadmin </em>. Esto solucionará los enlaces de administración en instalación Ingenium.';
$string['pathssubdataroot'] = '<p>Un directorio en el que Ingenium puede guardar los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  Ingenium.</p>';
$string['pathssubwwwroot'] = '<p>Dirección web completa para acceder a Ingenium, es decir, la dirección que los usuarios escribirán en la barra de búsqueda del navegador para acceder a Ingenium.</p>
<p>No es posible acceder a Ingenium utilizando múltiples direcciones. Si su portal tiene varias direcciones debe configurar la más sencilla y configurar un redireccionamiento permanente desde las otras.</p>
...
$string['phpversionhelp'] = '<p>Ingenium requiere una versión de PHP que sea al menos la 5.6.5 o 7.1 (7.0.x tiene algunas limitaciones del motor).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicaciones necesarias para que <strong>Ingenium</strong> funcione en su ordenador,
    principalmente:';
$string['welcomep40'] = 'El paquete también incluye <strong>Ingenium {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>Ingenium</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
$string['welcomep70'] = 'Pulse en el botón "Siguiente" para continuar con la configuración de <strong>Ingenium</strong>.';
